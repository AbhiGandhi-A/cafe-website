          ...
          <div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4 sm:gap-3">
              {highlights.map(({ icon: Icon, title }) => (
                <div
                  key={title}
                  className="flex flex-col items-center rounded-2xl border border-black/8 bg-white p-4 text-center shadow-sm transition-all hover:border-[#FFC928] hover:shadow-card"
                >
